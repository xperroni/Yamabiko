...
def statistics_forward_u():
    ...
    plots = [('Width', 0, 70), ('Height', 0, 70), ('U', -120, 70), ('V', -120, 70)]
    s = statistics(read_header_forward, 'u', bands, band_u_read, band_u_check_forward, *plots)
    s.load('/home/helio/Projects/Data/Landmarks/forward-2014-01-24-01.txt')
    s.plot()
...
def statistics_sideways_u():
    ...
    s.load('/home/helio/Projects/Data/Landmarks/sideways-2014-01-22-01.txt')
    s.plot()
...
def statistics_turning_u():
    ...
    s.load('/home/helio/Projects/Data/Landmarks/turning-2014-01-22-01.txt')
    s.plot()
