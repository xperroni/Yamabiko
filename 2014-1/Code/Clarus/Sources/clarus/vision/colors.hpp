...
namespace colors {
    ...
    */
    ...
    /*
    Merges the given channels into a single multi-channel image.
    */
    ...
    */
    ...
    /*
    Converts the input image to the given color space.
    */
    cv::Mat convert(const cv::Mat &image, int conversion);
