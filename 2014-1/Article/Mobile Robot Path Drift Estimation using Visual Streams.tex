...
\begin{algorithm}
\begin{algorithmic}
\State $t_r \gets t$ \Comment{Set replay session start time to current time}
\State $t_e \gets t$
\State $k \gets w$
\State $(x_0, y_0, \theta_0) \gets (0, 0, 0)$ \Comment{Initial robot pose}
